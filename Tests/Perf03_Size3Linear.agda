...
-- Size-3, purely linear graph (two sequential edges, still *no* choice at
-- all), negative decision. Isolates: does size-3 alone (independent of
-- branching) reproduce the CounterExamples slowdown, or is branching/choice
-- specifically required?

module Tests.Perf03_Size3Linear where
