# ARCHIVED — 2026-07-15 — status of the `Maybe` → `Dec` conversion

> Historical record, tracking a plan that was itself superseded. The
> module it reports on no longer exists.
